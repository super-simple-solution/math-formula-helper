  ...
  zhihu: {
    ...
    parser: (el) => {
      ...
      if (scriptEl.tagName === 'script') {
        console.log(scriptEl.textContent.trim())
      }
    },
  },
}
...
document.addEventListener('click', (e) => {
  ...
  if (target.classList?.contains('sss-copy')) {
    rules.zhihu.parser(target.parentNode)
  }
})
