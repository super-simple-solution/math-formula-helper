...
// Builds the injected hover/copy affordance CSS for all active formula selectors.
...
// Joins selector lists with an optional pseudo-class or copied-state suffix.
